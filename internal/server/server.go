...
func NewServer(addr string) *Server {
	...
	mux.HandleFunc("/api/v1/switch", handlers.NetworkChangeHandler(handlers.SwitchStackHandler(hub)))
	mux.HandleFunc("/api/v1/dns", handlers.NetworkChangeHandler(handlers.DnsHandler(hub)))
	mux.HandleFunc("/api/v1/warp", handlers.NetworkChangeHandler(handlers.WarpHandler(hub)))
	mux.HandleFunc("/api/v1/warp-mode", handlers.NetworkChangeHandler(handlers.WarpModeHandler(hub)))
	mux.HandleFunc("/api/v1/warp-status", handlers.WarpStatusHandler())
	mux.HandleFunc("/api/v1/home-network", handlers.NetworkChangeHandler(handlers.HomeNetworkHandler(hub)))
